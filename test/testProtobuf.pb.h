...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_testProtobuf_2eproto;
namespace rpcpr {
class LoginRequest;
...
inline int32_t LoginResponse::errcode() const {
  // @@protoc_insertion_point(field_get:rpcpr.LoginResponse.errcode)
...
inline void LoginResponse::set_errcode(int32_t value) {
  ...
  // @@protoc_insertion_point(field_set:rpcpr.LoginResponse.errcode)
}
...
inline const std::string& LoginResponse::errmsg() const {
  // @@protoc_insertion_point(field_get:rpcpr.LoginResponse.errmsg)
...
void LoginResponse::set_errmsg(ArgT0&& arg0, ArgT... args) {
 ...
 errmsg_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:rpcpr.LoginResponse.errmsg)
}
inline std::string* LoginResponse::mutable_errmsg() {
  std::string* _s = _internal_mutable_errmsg();
  // @@protoc_insertion_point(field_mutable:rpcpr.LoginResponse.errmsg)
  return _s;
}
...
inline std::string* LoginResponse::release_errmsg() {
  // @@protoc_insertion_point(field_release:rpcpr.LoginResponse.errmsg)
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:rpcpr.LoginResponse.errmsg)
}
